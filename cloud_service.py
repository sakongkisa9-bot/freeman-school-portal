...
class CloudService:
    ...
    def sync_students(self, students, credentials, school_details=None):
        payload = {
            "school_code": credentials["school_code"],
            "username": credentials["username"],
            "password": credentials["password"],
        ...
        if school_details:
            payload["school_details"] = school_details
    ...
    def toggle_portal(self, credentials):
        ...
        try:
            ...
            # Send credentials in JSON payload (like sync endpoints)
            payload = {
                "school_code": credentials["school_code"],
                "username": credentials["username"],
                "password": credentials["password"],
