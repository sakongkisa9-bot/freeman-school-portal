...
PYARMOR_PATH = Path(
    "C:/Users/HomePC/AppData/Local/Python/pythoncore-3.14-64/Scripts/pyarmor.exe"
)
...
def clean_obfuscated_dir():
    ...
    if OBFUSCATED_DIR.exists():
        try:
            ...
            print(
                "ERROR: Cannot clean obfuscated directory. The executable may still be running."
            )
