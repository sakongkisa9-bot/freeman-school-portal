...
class NewsletterCreator(ctk.CTkToplevel):
    ...
    def _build_wysiwyg_editor(self):
        ...
        bold_btn = ctk.CTkButton(toolbar_frame, text="B", command=lambda: self._apply_format("bold"), **btn_style)
        bold_btn.pack(side="left", padx=5, pady=5)
        
        italic_btn = ctk.CTkButton(toolbar_frame, text="I", command=lambda: self._apply_format("italic"), **btn_style)
        italic_btn.pack(side="left", padx=5, pady=5)
        
        underline_btn = ctk.CTkButton(toolbar_frame, text="U", command=lambda: self._apply_format("underline"), **btn_style)
    ...
    def _apply_format(self, format_type):
        ...
        try:
            ...
            # No text selected, just set the format for future typing
    ...
    def _insert_roman_list(self):
        """Insert a roman numeral list item"""
        try:
    ...
    def _insert_numbered_list(self):
        ...
        try:
            # Simple implementation - insert "1. " at cursor
